    ...
    <div className={classes.root}>
      ...
      >
        ...
        <ListItem button key='Home' onClick={handleHomeURL}>
          ...
          <ListItem button key='Take Test' onClick={() => { history.push('/studenttest') }}>
      ...
      >
        ...
        {!handleProfile && <div className='student-dashboard-container'>
          ...
          <div className='student-dashboard-button'>
            <Button type='button' variant='contained' color='secondary' onClick={()=>{history.push('/studenttest')}} className='student-dashboard-button color-button'>Start English Test</Button>
          </div>
